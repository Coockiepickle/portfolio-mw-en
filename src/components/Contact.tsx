...
const Contact = () => {
  ...
  return <section id="contact" className="relative py-16">
      ...
      <div className="mw-container relative z-10">
        <div className={cn("text-center max-w-3xl mx-auto mb-12 transition-all duration-700 transform", isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8")}>
          <div className="flex flex-col items-center">
            <span className="mw-badge mb-3">
        ...
        <div className={cn("mw-card p-5 transition-all duration-500 ease-out transform hover:shadow-lg hover:shadow-mw-green/20 hover:-translate-y-2 hover:border-mw-green/50", isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16", isVisible && 'delay-150')}>
          ...
          <div className="space-y-3">
            {/* Contact Message */}
            <div>
              <p className="text-mw-lightgray mb-4">Have a project in mind? Want me to be a part of your company? Just send me an e-mail and I'll answer as fast as possible.</p>
              
              <div className="p-3 border border-dashed border-mw-green border-opacity-30 rounded-sm bg-mw-darker bg-opacity-50 mb-4">
            ...
            <div>
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://github.com/Coockiepickle" className="inline-flex items-center justify-center px-3 py-1.5 bg-mw-green bg-opacity-10 hover:bg-opacity-20 border border-mw-green border-opacity-20 rounded-sm text-mw-green transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md hover:shadow-mw-green/30">
                  <Github className="w-4 h-4 mr-2" />
                  GitHub
                </a>
                <a href="https://linkedin.com/in/dreynaud" className="inline-flex items-center justify-center px-3 py-1.5 bg-mw-green bg-opacity-10 hover:bg-opacity-20 border border-mw-green border-opacity-20 rounded-sm text-mw-green transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md hover:shadow-mw-green/30">
